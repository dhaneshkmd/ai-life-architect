...
const App: React.FC = () => {
  ...
  const tosContent = "Placeholder for Terms of Service. This is where the full terms and conditions for using AI Life Architect would be displayed.";
  const privacyContent = "Placeholder for Privacy Policy. This section would detail how user data is collected, stored, and used, emphasizing the 'Private by Design' principles.";
